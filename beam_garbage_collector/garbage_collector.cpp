...
void GarbageCollector::Collect(){
    ...
    if(number_of_objects_garbage_collected != 0u) Console::PrintLine("[UFO-Engine] Beam Garbage Collector ran, collected",number_of_objects_garbage_collected,"instances of gc::Object");
